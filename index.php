...
<div class="container">
<a class="navbar-brand" href="#"> <i class="fas fa-utensils"></i>  Sabores de Colombia </a>
...
<section  class="container-fluid p-0">
  <div class="banner-img" style="position:relative; background:url('images/slider-image2.jpg') center/cover no-repeat; height:400px; ">
...
<section id="id" class="container mt-4 text-center">
    <div class="jumbotron bg-dark text-white">
      <br/>
        <h2>¡Sabores de Colombia!</h2>
        <p> ¡Descubre el mejor restaurante de comida variada Colombiana!</p>
      <br/>
    </div>
</section>
...
<div id="horario" class="text-center bg-light p-4">
  ...
  <footer class="bg-dark text-light text-center py-3">
    <!-- place footer here -->
    <p> &copy; 2024 Restaurant Sabores de Colombia, todos los derechos reservados.</p>
